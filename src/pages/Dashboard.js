...
const TableHeader = ({shuffle}) => (
  ...
  <div className='row mb-1 mt-4'>
    <div className='col-sm-12'><h3>Payments</h3></div>
  </div>
...
const TableFooter=()=>(
  <div className='row table-footer'>
    <div className='col-sm-6'>
      <span>Showinf 1 to 10 of 500 entries</span>
    </div>
...
export default()=>{
  const record = ['Pending', 'Reconciled', 'Un-reconciled', 'Pending', 'Reconciled', 'Un-reconciled', 'Pending', 'Reconciled', 'Un-reconciled', 'Pending', 'Reconciled', 'Un-reconciled', 'Pending', 'Reconciled', 'Un-reconciled']
  ...
  const shovelStatus = (e)=>{
    ...
    if(status==='All')
    return setdisplayStatus(record);
          ...
          <div className='row'>
            ...
            <div className='pymt row mt-2'>
              <table>
                ...
                <tbody>
                  {Notfound ? <h5 className='text-center'>No Result Found</h5> : showStatus}
                </tbody>
              </table>
            </div>
            <TableFooter />
